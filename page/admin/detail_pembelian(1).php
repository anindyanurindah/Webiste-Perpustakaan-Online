...
?>
<div style="margin-top:30px;width:100%,height:50px;text-align:center;background:#9A9483;color:#fff;line-height:60px;font-size:20px;margin-bottom:20px;">
<b>Detail Pembelian</b>
</div>
<table class="table table-bordered">
		<th style=" background: #E5DCC3; "><center>Judul Buku</center></th>
 		<th style=" background: #E5DCC3; "><center>Qty</center></th>
 		<th style=" background: #E5DCC3; "><center>Total Harga</center></th>
 		<th style=" background: #E5DCC3; "><center>Total Bayar</center></th>
