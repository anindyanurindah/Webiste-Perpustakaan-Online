...
?>
<div class="row">
<div style="margin-top:-10px;width:100%,height:50px;text-align:center;background:#9A9483;color:#fff;line-height:60px;font-size:20px; margin-bottom:25px;">
<b>Data Kategori</b>
</div>
<a href="index.php?page=kategori&aksi=input" class="btn btn-success" style="margin:17px; background: #C7BEA2; color: darkblue;"><span class="glyphicon glyphicon-plus"> TAMBAH KATEGORI</span></a>
<?php
@$aksi = $_GET['aksi'];
if($aksi=="input")
{
...
<table class="table table-bordered">
 	<tr>
		<th style=" background: #E5DCC3; "><center>No</center></th>
		<th style=" background: #E5DCC3; "><center>Kategori</center></th>
